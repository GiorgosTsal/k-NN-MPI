...
// Standard partition process of QuickSort() but with index.
...
//This function calculates euclidean distances with cblas lib based on matlab given type: sqrt(sum(X.^2,2) -2* X*Y.' + sum(Y.^2,2).') <= (tautotita)
